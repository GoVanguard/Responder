...
try:
    ...
    print("\Crypto lib is not installed. You won't be able to live dump the hashes.")
    print("You can install it on debian based os with this command: apt-get install python-crypto")
    print("The Sam file will be saved anyway and you will have the bootkey.")
try:
    import readline
except:
